...
//  fprintf (stderr, "Amount of data transfered to the device is %lld GB\n", bytes4euc/1000000000);
  ...
  void* kernel_ptr = (void*)WarpSpec_RegBuffer_Kernel_21<data_type, datasize_type, BLOCKSIZEX, BLOCKSIZEY, FAKE_BLOCKSIZEY>;
  ...
  // call the kernel
  WarpSpec_RegBuffer_Kernel_21<data_type, datasize_type, BLOCKSIZEX, BLOCKSIZEY, FAKE_BLOCKSIZEY><<< grid, threads, dynSmemSize>>>( d_A, d_B, d_C, Arows, Bcols, AcolsBrows, alpha, beta);
