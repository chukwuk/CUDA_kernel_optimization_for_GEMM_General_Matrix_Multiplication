...
__global__  void naive2D_GEMM_Kernel_2(float* d_A, float* d_B,  float* d_C, unsigned int Arows, unsigned int Bcols, unsigned int AcolsBrows, float alpha, float beta);
